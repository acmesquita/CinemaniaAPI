...
class FilmesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filme" do
    assert_difference('Filme.count') do
      post filmes_url, params: { filme: { capa: @filme.capa, duracao: @filme.duracao, estreia: @filme.estreia, genero: @filme.genero, nota: @filme.nota, sinopse: @filme.sinopse, titulo: @filme.titulo } }
    end
  ...
  test "should update filme" do
    patch filme_url(@filme), params: { filme: { capa: @filme.capa, duracao: @filme.duracao, estreia: @filme.estreia, genero: @filme.genero, nota: @filme.nota, sinopse: @filme.sinopse, titulo: @filme.titulo } }
